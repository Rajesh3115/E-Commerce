...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
		  ...
		  @if($data->logo)
			<img src="{{ asset($data->logo) }}" class="img-fluid zoom" style="max-width:80px" alt="{{ $data->logo }}"><br>
		  @endif
        ...
        <div class="form-group">
		  ...
		  @if($data->photo)
			<img src="{{ asset($data->photo) }}" class="img-fluid zoom" style="max-width:80px" alt="{{ $data->photo }}"><br>
		  @endif
          <div class="input-group">
